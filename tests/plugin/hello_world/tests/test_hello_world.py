...
def test_simple_action():
    run_action('./tests/plugin/hello_world/tests/action/hello/input.json',
               './tests/plugin/hello_world/tests/action/hello/output.json', plugin)


def test_simple_trigger():
    run_trigger('./tests/plugin/hello_world/tests/trigger/hello_trigger/input.json',
                './tests/plugin/hello_world/tests/trigger/hello_trigger/output.json', plugin)


def test_bad_action():
    with pytest.raises(Exception):
        run_action('./tests/plugin/hello_world/tests/action/throw_exception/input.json',
                   './tests/plugin/hello_world/tests/action/throw_exception/output.json', plugin)


def test_bad_trigger():
    run_trigger('./tests/plugin/hello_world/tests/trigger/throw_exception_trigger/input.json',
                './tests/plugin/hello_world/tests/trigger/throw_exception_trigger/output.json', plugin,
                expect_timeout=True)

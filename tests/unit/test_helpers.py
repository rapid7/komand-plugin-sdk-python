...
def test_clean_not_equal_list_successful():
    ...
    assert sample != helper.clean(["one", {"two": "", "three": None}, {"four": 4}, None])
...
def test_clean_not_equal_dict_successful():
    ...
    assert sample != helper.clean({"one": [1, None, "", {"two": None}, {"three": 3}], "four": 4})
...
def test_get_hashes_string_equal_successful():
    ...
    assert {"md5": "c3fcd3d76192e4007dfb496cca67e13b",
            ...
            "sha512": "4dbff86cc2ca1bae1e16468a05cb9881c97f1753bce3619034898faa1aabe429955a1bf8ec483d7421fe3c1646613" +
                      "a59ed5441fb0f321389f77f48a879c7b1f1"} == helper.get_hashes_string(test_string)
...
def test_check_hashes_false_sha1_failure():
    test_string = "abcdefghijklmnopqrstuvwxyz"
    assert not helper.check_hashes(test_string, "32d10c7b8cf96570ca04ce37f2a19d84240d3aasdf")


def test_check_hashes_true_sha256_success():
    test_string = "abcdefghijklmnopqrstuvwxyz"
    assert helper.check_hashes(test_string,
                               "71c480df93d6ae2f1efad1447c66c9525e316218cf51fc8d9ed832f2daf18b73")


def test_check_hashes_false_sha256_failure():
    test_string = "abcdefghijklmnopqrstuvwxyz"
    assert not helper.check_hashes(test_string,
